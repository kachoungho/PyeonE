...
<nav class="w3-sidenav w3-white w3-animate-left w3-large"
	...
	<sec:authorize ifNotGranted="ROLE_USER">
		<a style="color: #054A75" href="login"><i class="fa fa-lock"
			aria-hidden="true"></i>&nbsp;&nbsp;로그인</a>
	</sec:authorize>

	<sec:authorize access="hasAuthority('ROLE_USER')">
		<a style="color: #054A75" href="j_spring_security_logout"><i
			class="fa fa-unlock-alt" aria-hidden="true"></i>&nbsp;&nbsp;로그아웃</a>
	</sec:authorize>

	<br> <br> <br> <a
		href="${pageContext.request.contextPath}/"><i class="fa fa-search"
		aria-hidden="true"></i>&nbsp;&nbsp;상품 검색</a>
	<sec:authorize ifNotGranted="ROLE_USER">
		<a href="login"><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp;&nbsp;재고
			요청 게시판</a>
	</sec:authorize>
	<sec:authorize access="hasAuthority('ROLE_USER')">
		<a href="req_board_list"><i class="fa fa-list-alt"
			aria-hidden="true"></i>&nbsp;&nbsp;재고 요청 게시판</a>
	</sec:authorize>
	<a href="cus_hit"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>&nbsp;&nbsp;인기
		상품</a>
