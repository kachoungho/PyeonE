...
<body>
	...
	<div
		...
		<form action="${pageContext.request.contextPath}/customer/req_board_list" method="post">
			...
			<br> <input
				style="display: block; float: right; margin-right: 50px;"
				width="40" type="image" src="/controller/images/write.png"
				alt="submit">
		</form>
	</div>
