						...
						<tbody>
							<tr>
								...
								<td style="padding-top: 20px; text-align: center"
									data-code="${list.item_code}" data-name="${list.item_name}"
									data-cate="${list.category }" data-id="${name }"><input
		...
		<div style="float: left; width: 50%;">
			<div
               ...
               method="post"> --%>
				...
				<table class="w3-table w3-hoverable w3-border">
					<tr>
						<th class="w3-blue-grey" style="width: 2%; text-align: center">상품
							코드</th>
						<td colspan="2"><input id="input_order" type="text"
							class="orderTemp1" name="item_code" value="${item_code}"></td>
					</tr>
					<tr>
						<th class="w3-blue-grey" style="width: 20%; text-align: center">상품
							이름</th>
						<td colspan="2"><input id="input_order" type="text"
							class="orderTemp2" name="item_name" value="${item_name}"></td>
					</tr>
					<tr>
						<th class="w3-blue-grey" style="width: 20%; text-align: center">상품
							갯수</th>
						<td colspan="2"><input id="input_order" type="text"
							class="orderTemp5" name="count"></td>
					</tr>
					<tr>
						<th class="w3-blue-grey" style="width: 20%; text-align: center">카테고리</th>
						<td colspan="2"><input id="input_order" type="text"
							class="orderTemp3" name="category" value="${category}"></td>
					</tr>
					<tr>
						<th class="w3-blue-grey" style="width: 20%; text-align: center">지
							점</th>
						<td><input id="input_order" type="text" name="area"
							class="orderTemp4" value="${area}" readonly="readonly"></td>
				...
				<table class="w3-table w3-hoverable w3-border">
					<thead>
						<tr class="w3-blue-grey">
							...
							<th style="width: 10%; text-align: center; padding-top: 15px">수
								량</th>
							<th style="width: 10%; text-align: center">카테<br>고리
							</th>
							<th style="width: 10%; text-align: center; padding-top: 15px;">지
								점</th>
							...
							function(data) {
								...
								$(data)
										.each(
												function() {
													str += "<tr>";
													str += "<td style='width: 10%; padding-top: 20px; text-align: center; resize: none;'>"
															+ this.item_code
															+ "</td>";
													str += "<td style='width: 20%; padding-top: 20px; text-align: center; resize: none;'>"
															+ this.item_name
															+ "</td>";
													str += "<td style='width: 10%; padding-top: 20px; text-align: center; resize: none;'>"
															+ this.count
													...
													str += "<td style='width: 10%; padding-top: 20px; text-align: center; resize: none;'>"
															+ this.area
															+ "</td>";
													str += "<td style='width: 20%; text-align: center; resize: none;'>"
															+ this.p2_time
															+ "</td>";
													str += "<td style='width: 10%; padding-top: 20px; text-align: center; resize: none;' id='deleteBtn' data-code='"+this.item_code+"' data-area='"+this.area+"'><input width='20' type='image' src='/controller/resources/images/delete.png' alt='button'></td>"
													str += "</tr>";
												});
