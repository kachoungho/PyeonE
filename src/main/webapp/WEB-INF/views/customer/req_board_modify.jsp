...
<body>
	...
	<div
		...
		<sec:authorize access="hasAuthority('ROLE_CUS')">
			<form
				action="${pageContext.request.contextPath}/customer/req_board/update"
				method="post">
		</sec:authorize>
		<sec:authorize access="hasAuthority('ROLE_ADMIN')">
			<form
				action="${pageContext.request.contextPath}/company/req_board_update"
				method="post">
		</sec:authorize>
		<label
