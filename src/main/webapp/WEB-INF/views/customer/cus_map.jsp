...
<head>
<meta charset="UTF-8">
<title>키워드로 장소검색하고 목록으로 표출하는 Map</title>
<style>
.map_wrap, .map_wrap * {
   margin: 0;
   padding: 0;
...
<body>
         ...
         <div class="option">
            <div>
               ...
               <c:forEach items="${list}" var="list">
                  키워드 : <input type="text" value="${list.address}" id="keyword" size="15">
                  </c:forEach>
   ...
   <script type="text/javascript"
      src="//apis.daum.net/maps/maps3.js?apikey=d8a783ab647cf241b46707bc4e31d1ac&libraries=services"></script>
   <script>
      // 마커를 담을 배열입니다
      var markers = [];
