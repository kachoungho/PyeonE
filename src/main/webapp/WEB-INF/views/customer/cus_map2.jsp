...
<body>
		...
		<table>
			<c:forEach items="${list}" var="list">
				...
				<tr>
					<td id="td1">홈페이지</td>
					<td id="td2"><a
						href="${pageContext.request.contextPath}/customer/cus_sector?area=${list.area}&item_name=${item_name}">홈페이지
							이동</a></td>
				</tr>
			</c:forEach>
		</table>
	...
	<div id="div2">
		<c:forEach items="${list}" var="list">
			...
			<input type="hidden" value="${list.phone}" id="phone" size="15">
		</c:forEach>


		<div id="map" style="width: 350px; height: 350px;"></div>
		<!-- margin-left: 30.5%; margin-top: 5%; margin-bottom: 5%; -->
		...
		<script>
			...
			function displayMarker(keyword) {
				...
				var marker = new daum.maps.Marker({
					map : map,
					position : new daum.maps.LatLng(keyword.latitude,
							keyword.longitude)
				});
