...
<body>
	...
	<br>
	<form
		action="${pageContext.request.contextPath}company/com_stock_select"
		method="post">
		...
		</select> 검색할 제품 : <input type="text" name="item_name"> <input
	...
	<div class="text-center">
		<ul class="pagination">
			<c:if test="${pageMaker.prev }">
				<li><a
					href="${pageContext.request.contextPath}company/com_stock_select?page=${pageMaker.startPage - 1 }&category=${category}&item_name=${item_name}">&laquo;</a></li>
			</c:if>
			...
			<c:forEach begin="${pageMaker.startPage }"
				...
				<li
					...
					<a
					href="${pageContext.request.contextPath}company/com_stock_select?page=${idx}&category=${category}&item_name=${item_name}">${idx }</a>
				</li>
			</c:forEach>

			<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
				<li><a
					href="${pageContext.request.contextPath}company/com_stock_select?page=${pageMaker.endPage + 1 }&category=${category}&item_name=${item_name}">&raquo;</a></li>
			</c:if>
		</ul>
	</div>
</body>
